...
export default async function CustomVideosPage() {
    ...
    // Filter for Custom Videos (Creatomate)
    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h1 className="text-3xl font-bold">Custom Videos</h1>
                    <p className="text-muted-foreground">Template based video edits</p>
                </div>
                <Link href="/custom-videos/new">
                    <Button>+ New Custom Video</Button>
                </Link>
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                ...
                {(!videos || videos.length === 0) && (
                    <div className="col-span-full text-center py-10 bg-muted/20 rounded-lg border-dashed border-2">
                        <p className="text-muted-foreground mb-4">No custom videos generated yet.</p>
                        <Link href="/custom-videos/new"><Button variant="outline">Create your first custom video</Button></Link>
                    </div>
                )}
            </div>
        </div>
